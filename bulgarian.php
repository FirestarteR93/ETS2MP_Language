...
$_lang["steamid.in.use"] = "Посочения steam потребител вече има регистриран ETS2MP профил. <a href=\"http://ets2mp.com/index.php?page=contact\">Свържете се с нас</a> при проблем с регистрацията.";
$_lang["mail.does.not.match"] = "Посочената Е-Поща не съответства.";
$_lang["support"] = "Поддръжка";
$_lang["profile"] = "Профил";
$_lang["group"] = "Група";
$_lang["banned"] = "Banned";
$_lang["state"] = "Състояние";
$_lang["account.is.activated"] = "Профилът е активиран";
$_lang["account.isnt.activated"] = "Профилът не е активиран";
$_lang["penalty.history"] = "История на назанията";
$_lang["no.punishments"] = "Няма наказания.";
$_lang["date"] = "Дата";
$_lang["reason"] = "Причина";
$_lang["type"] = "Тип";
$_lang["penalty.limit"] = "Само собственикът на профила може да види всичките си наказания.";
$_lang["error.cannot.fetch.steam.api"] = "Неуспешна връзка с Steam api. Опитайте по-късно.";
$_lang["remember.me"] = "Запомни ме";
$_lang["news.is.not.visible.anymore"] = "Новините са скрити";
$_lang["could.not.make.the.news.invisible"] = "Неуспешно скриване на новините";
$_lang["we.are.displaying.the.news"] = "Показване на новините";
$_lang["could.not.display.the.news"] = "Неуспешно показване на новините";
$_lang["news.added"] = "Добавена новина";
$_lang["could.not.add.the.news"] = "Неуспешно добавяне на новина";
$_lang["writted.by"] = "Написано от";
$_lang["message"] = "Съобщение";
$_lang["posted.at"] = "Публикувано в";
$_lang["hide.show"] = "Покажи/Скрий";
$_lang["hide"] = "Покажи";
$_lang["show"] = "Скрий";
$_lang["you.do.not.have.access.to.this.page"] = "Достъпът Ви до тази страница е ограничен";
$_lang["name"] = "Име";
$_lang["rank"] = "Длъжност";
$_lang["status"] = "Статус";
$_lang["error.try.again"] = "Грешка! Опитайте отново";
$_lang["not.connected"] = "Не е свързан";
$_lang["not.banned"] = "Няма наложен ban";
$_lang["ban.appeal"] = "Обжалване на ban";
$_lang["power.revoked"] = "Отнета власт";
$_lang["ban.appeal.sent"] = "Обжалването е изпратено";
$_lang["could.not.submit.ban.appeal"] = "Неуспешно изпращане на обжалването";
$_lang["your.in.game.name.when.banned"] = "Името ви в играта";
$_lang["why.should.you.be.unbanned"] = "Защо желаете да обжалвате?";
$_lang["screenshot.video.if.applicable"] = "Снимка/Видео, ак имате такива";
$_lang["can.not.send.ban.appeal"] = "Неуспешно изпращане на обжалването";
$_lang["status.change"] = "Промяна в статуса";
$_lang["banned"] = "Блокиран";
$_lang["unban"] = "Премахване на забраната";
$_lang["could.not.change.status"] = "Неуспешна смяна на статуса";
$_lang["comment.added"] = "Коментарът е добавен";
$_lang["comment.could.not.be.added"] = "Неуспешно добавяне на коментара";
$_lang["comment.deleted"] = "Коментарът е изтрит";
$_lang["comment.edited"] = "Коментарът е променен";
$_lang["ban.appeal.information"] = "Ивформация за обжалването";
$_lang["ban.appeal.accept.decline"] = "Приеване/Отказване на наказанието";
$_lang["ban.appeal.must.comment"] = "Трябва да отговорите в коментара на обжалването";
$_lang["ban.expiry"] = "Наказанието изтича";
$_lang["ban.on.system"] = "Блокиране от системата";
$_lang["comment.has.been.disable"] = "Коментарите са забранени";
$_lang["view.ban.appeal.list"] = "Покажи листа с обжалванията";
$_lang["manage"] = "Управление";
$_lang["home"] = "";
$_lang["reminder.must.wait.three.days"] = "Напомняне: трябва да изчакате 3 дни";
$_lang["create.ban.appeal"] = "Напишете обжалване";
$_lang["view.my.ban.appeal"] = "Виж обжалването";
$_lang["forum.log"] = "Дневник";
$_lang["not.enough.permissions"] = "Недосатъчни правомощия";
$_lang["speed.hack"] = "speedhack";
$_lang["must.log.in"] = "Трябва да сте влезли";
$_lang["ban.appeal.must.be.english"] = "Обжалването трябва да е написано на Английски";
